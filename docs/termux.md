...
Metis runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
Create `~/.metis/agent/AGENTS.md` to help the agent understand the Termux environment:
