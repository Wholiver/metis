...
export default function PromptBar({
  ...
  }, [draft, expanded, resolvedInputRef]);
      ...
      <div ref={composerAnchorRef} className="relative">
        ...
        <form
          ...
          className={`relative isolate flex flex-col overflow-hidden border border-line bg-surface shadow-card transition-[border-color,border-radius] duration-150 focus-within:border-line-strong ${
            ...
            pill ? (resolvedAttachmentCount > 0 || wide ? "rounded-[24px]" : "rounded-full") : tall ? "rounded-[22px]" : "rounded-[14px]"
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className={`${
                tall
                  ? "min-h-[68px] px-2 py-2 text-[14px] font-normal leading-[1.8]"
                  : wide
                    ? "min-h-7 px-1 py-0 text-[14px] font-normal leading-[1.8]"
