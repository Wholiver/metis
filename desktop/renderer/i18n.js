(() => {
	...
	const phrases = [
		...
		["customBaseUrlDescription", "添加一个 OpenAI-compatible Provider。名称、Base URL 与 API Key 作为一组独立配置保存。", "Add an OpenAI-compatible Provider. Its name, Base URL, and API Key are saved as one separate configuration."],
