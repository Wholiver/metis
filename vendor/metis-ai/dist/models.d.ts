...
import type { Api, ApiStreamOptions, AssistantMessage, AssistantMessageEventStream, Context, Model, ModelThinkingLevel, ProviderHeaders, ProviderStreams, SimpleStreamOptions, ThinkingOption, Usage } from "./types.ts";
...
export declare function getThinkingOptions<TApi extends Api>(model: Model<TApi>): ThinkingOption[];
