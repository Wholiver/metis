 ...
 * - Routing tool calls to remote systems (e.g., Metis-ssh-remote)
...
import type { TextContent } from "@earendil-works/metis-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "metis";
...
export default function (metis: ExtensionAPI) {
	...
	metis.registerCommand("read-log", {
