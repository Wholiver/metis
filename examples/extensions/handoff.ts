...
import { complete, type Message } from "@earendil-works/metis-ai/compat";
import type { ExtensionAPI, SessionEntry } from "metis";
import { BorderedLoader, convertToLlm, serializeConversation } from "metis";
