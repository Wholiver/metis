 ...
 *   metis -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... metis -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (metis: ExtensionAPI) {
	metis.registerProvider("custom-anthropic", {
