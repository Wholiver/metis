 ...
 * Delegates to metis-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   metis -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (metis: ExtensionAPI) {
	metis.registerProvider("gitlab-duo", {
