#!/usr/bin/env bash
# Build DOOM for metis-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_metis.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
