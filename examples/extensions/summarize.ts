import { complete, getModel } from "@earendil-works/metis-ai/compat";
import type { ExtensionAPI, ExtensionCommandContext } from "metis";
import { DynamicBorder, getMarkdownTheme } from "metis";
import { Container, Markdown, matchesKey, Text } from "@earendil-works/metis-tui";
...
export default function (metis: ExtensionAPI) {
	metis.registerCommand("summarize", {
