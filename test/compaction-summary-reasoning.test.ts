...
import type { AssistantMessage, Model } from "@earendil-works/metis-ai";
...
vi.mock("@earendil-works/metis-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/metis-ai/compat")>();
	return {
		...actual,
