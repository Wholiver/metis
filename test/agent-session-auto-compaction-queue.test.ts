...
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@earendil-works/metis-ai";
...
describe("AgentSession auto-compaction queue resume", () => {
	...
	beforeEach(() => {
		tempDir = join(tmpdir(), `metis-auto-compaction-queue-${Date.now()}`);
