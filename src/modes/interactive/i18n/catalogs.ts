...
export const en = {
	...
	"header.more": "More     ",
	"header.startupHelp": "press {key} for startup help and loaded resources",
	...
	"header.switchWorkflow": "to switch Build / Plan mode",
	...
	"plan.preview.ready": "Plan ready",
	"plan.preview.drafting": "Drafting plan",
	"plan.preview.lines": { one: "1 line", other: "{count} lines" },
	"plan.preview.hidden": "{count} more lines · full plan saved in session",
	"plan.actions.next": "What next?",
	"plan.actions.process": "Process",
	"plan.actions.processDescription": "Switch to Build and implement this plan.",
	"plan.actions.edit": "Edit plan",
	"plan.actions.editDescription": "Send feedback and create a new revision.",
	"plan.actions.feedback": "What should change?",
	"plan.actions.feedbackRequired": "Enter feedback before submitting.",
	"plan.actions.select": "select",
	"plan.actions.confirm": "confirm",
	"plan.actions.dismiss": "chat",
	"plan.actions.submit": "submit changes",
	"plan.actions.back": "back",
	"executionPlan.title": "Execution plan",
	"executionPlan.progress": "{completed}/{total} completed",
	"executionPlan.legacy": "legacy plan",
	"executionPlan.interrupted": "interrupted · can continue",
	"executionPlan.readingProposal": "reading approved proposal",
	"executionPlan.creatingChecklist": "creating execution checklist",
	"executionPlan.empty": "execution checklist not ready",
...
const zhCN: TranslationCatalog = {
	...
	"header.shortcuts": "快捷键", "header.more": "更多     ", "header.startupHelp": "按 {key} 查看启动帮助和已加载资源",
	...
	"header.toExitEmpty": "空输入时退出", "header.toSuspend": "挂起", "header.toDeleteEnd": "删除至行尾", "header.toCycleThinking": "切换思考级别", "header.switchWorkflow": "切换构建 / 规划模式",
	...
	"plan.preview.ready": "方案已就绪", "plan.preview.drafting": "正在编写方案", "plan.preview.lines": { other: "{count} 行" },
	"plan.preview.hidden": "另有 {count} 行 · 完整方案已保存在会话中", "plan.actions.next": "下一步？",
	"plan.actions.process": "Process", "plan.actions.processDescription": "切换到 Build 并执行此方案。", "plan.actions.edit": "修改方案",
	"plan.actions.editDescription": "提交意见并生成新版方案。", "plan.actions.feedback": "需要修改什么？", "plan.actions.feedbackRequired": "请先输入修改意见。",
	"plan.actions.select": "选择", "plan.actions.confirm": "确认", "plan.actions.dismiss": "对话", "plan.actions.submit": "提交更改", "plan.actions.back": "返回",
	"executionPlan.title": "执行计划", "executionPlan.progress": "已完成 {completed}/{total}", "executionPlan.legacy": "旧版计划", "executionPlan.interrupted": "已中止 · 可继续",
	"executionPlan.readingProposal": "正在读取已确认方案", "executionPlan.creatingChecklist": "正在建立执行清单", "executionPlan.empty": "执行清单尚未建立",
};
