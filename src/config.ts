...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/earendil-works/metis/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.METIS_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json metisConfig)
// =============================================================================
...
const metisConfigName: string | undefined = pkg.metisConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "metis";
export const APP_NAME: string = metisConfigName || "metis";
export const APP_TITLE: string = metisConfigName ? APP_NAME : "Metis";
export const CONFIG_DIR_NAME: string = pkg.metisConfig?.configDir || ".metis";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., METIS_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://metis.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.METIS_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.metis/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.metis/agent/) */
