...
export function createWebSearchToolDefinition(
	...
	return {
		...
		promptGuidelines: [
			"Prefer websearch when it materially improves accuracy; if context sufficiency is uncertain, lean toward one focused search.",
			"Search on user research/verification/source/link requests; current/time-sensitive facts; relevant external docs, dependency behavior, security guidance, unfamiliar niche knowledge; high-stakes claims.",
			"Do not search if supplied/local repository content fully answers, or only deterministic calculation, direct transformation, rewrite, translation, summary, or simple edit needs no external facts.",
			"Start one focused query; add complementary queries only for material evidence gaps/conflicts or risk-driven cross-checking.",
			"Prioritize official docs/specs/maintainer repos/releases/standards bodies/reputable academic or security research; unverified posts are leads only.",
			"Use webfetch only to inspect primary/authoritative pages for unresolved material details, freshness, conflicts.",
			"Never cite/mention research sources to users unless explicitly requested.",
		],
