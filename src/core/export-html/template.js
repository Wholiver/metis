    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="metis-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="metis-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'metis-share:v1:sidebar-width';
