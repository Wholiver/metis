...
import type { AgentMessage, StreamFn } from "@earendil-works/metis-agent-core";
import type { Model, SimpleStreamOptions } from "@earendil-works/metis-ai/compat";
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from metis-generated summaries (fromHook !== true), not extension-generated ones
