...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@earendil-works/metis-agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@earendil-works/metis-ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if metis-generated)
